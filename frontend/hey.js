...
function generateCardSVG(card) {        
    const bgColor = flavorsColors[card.family];
    ...
    switch(card.family) {
        ...
        case 'base':
            switch(card.name.toLowerCase()) {
                case 'génoise':
                    return displaySpongCakeCard(card, bgColor, borderColor, borderWidth);
                case 'biscuit' :
                    return displayBiscuitCard(card, bgColor, borderColor, borderWidth);
                case 'dacquoise' :
                    return displayDacquoiseCard(card, bgColor, borderColor, borderWidth);
                case 'pâte feuilletée' :
                    return displayPuffPastry(card, bgColor, borderColor, borderWidth);
            }
        case 'cream':
        ...
        default : 
            return `
                <svg viewBox="0 0 200 280" xmlns="http://www.w3.org/2000/svg">
                    <rect x="10" y="10" width="180" height="260" fill="${bgColor}" rx="10"
        ...
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style="background: transparent;">
            <defs>
                <linearGradient id="baseGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style="stop-color:#E6B98A;" />
            ...
            <text x="100" y="145" text-anchor="middle" font-size="14" font-weight="bold" fill="#3E2723" font-family="sans-serif">
